...
int GvsPlanarSurf::SetParam(std::string pName, m4d::Matrix<double, 3, 4> mat)
{
...
bool GvsPlanarSurf::testLocalIntersection(GvsRay&, const int, const int, const m4d::vec4, const m4d::vec4)
{
    // pure virtual
    return false;
}

bool GvsPlanarSurf::testLocalIntersection(GvsRay&, const int, const int, const m4d::vec4, const m4d::vec4, GvsSurface*)
{
    // pure virtual
    return false;
}

bool GvsPlanarSurf::allLocalIntersections(
...
GvsBoundBox GvsPlanarSurf::boundingBox(void) const
{
    return planarSurfBoundBox;
}

bool GvsPlanarSurf::rayIntersect(const m4d::vec3& p0, const m4d::vec3& p1, double tp0, double tp1, double& alpha,
    double& thit, m4d::vec3& rayIntersecPnt) const
{

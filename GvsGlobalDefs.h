...
const std::string GvsDataTypeName[14]
    = { "gvsDT_UNKNOWN", "gvsDT_INT", "gvsDT_FLOAT", "gvsDT_DOUBLE", "gvsDT_VEC2", "gvsDT_VEC3", "gvsDT_VEC4",
          "gvsDT_MAT2D", "gvsDT_MAT3D", "gvsDT_IVEC2", "gvsDT_IVEC3", "gvsDT_IVEC4", "gvsDT_STRING", "gvsDT_VOID" };
...
enum GvsSetParamHint { gvsSetParamError = -1, gvsSetParamNone = 0, gvsSetParamAdjustTetrad };
...
enum GvsCamFilter {
    ...
    gvsCamFilterRGBIntersec // rgb image + save all intersections
};

const int GvsNumCamFilters = 5;
const std::string GvsCamFilterNames[GvsNumCamFilters]
    = { "FilterRGB", "FilterRGBpdz", "FilterRGBjac", "FilterRGBpt", "FilterRGBIntersec" };

enum GvsCamEye { gvsCamEyeStandard = 0, gvsCamEyeLeft, gvsCamEyeRight };

const int GvsNumCamEyes = 3;
const std::string GvsCamEyeNames[GvsNumCamEyes] = { "Standard", "LeftEye", "RightEye" };
const std::string GvsCamEyeFileExt[GvsNumCamEyes] = { ".", ".left.", ".right." };

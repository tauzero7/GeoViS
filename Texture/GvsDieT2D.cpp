...
#else
const double eyePointDie[][2] = { { 0.5, 0.5 }, { 0.25, 0.25 }, { 0.75, 0.75 }, { 0.25, 0.75 }, { 0.5, 0.5 },
    { 0.75, 0.25 }, { 0.25, 0.25 }, { 0.75, 0.25 }, { 0.25, 0.75 }, { 0.75, 0.75 }, { 0.25, 0.25 }, { 0.75, 0.25 },
    { 0.25, 0.75 }, { 0.75, 0.75 }, { 0.5, 0.5 }, { 0.25, 0.25 }, { 0.25, 0.5 }, { 0.25, 0.75 }, { 0.75, 0.27 },
    { 0.75, 0.5 }, { 0.75, 0.75 } };
#endif
...
GvsDieT2D::GvsDieT2D(GvsTexture* t0, GvsTexture* t1, const m4d::Matrix<double, 2, 3>& mat, int eyes)
    : GvsTexture2D(mat)
    , tex0(t0)
    , tex1(t1)
    , numEyes(eyes)
...
void GvsDieT2D::setTexture0(GvsTexture* tex)
{
    tex0 = tex;
    assert(tex0 != NULL);
}

void GvsDieT2D::setTexture1(GvsTexture* tex)
{
    tex1 = tex;
    assert(tex1 != NULL);
}
